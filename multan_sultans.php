...
<head>
  <meta charset="UTF-8">
  <title>Multan Sultans Squad PSL 10</title>
...
<!-- Navbar -->
<header class="bg-green-700 text-white p-4 shadow-md sticky top-0 z-50">
...
<section class="py-10 bg-green-600 text-white text-center">
  <h2 class="text-3xl font-bold mb-4">Multan Sultans Squad – PSL 10</h2>
  <p class="mb-8">The Sultans are here to rule the field in PSL 10!</p>

  <?php if ($captain): ?>
    <div class="max-w-xl mx-auto bg-blue-400 p-6 rounded-lg shadow-lg flex flex-col items-center">
