...
<head>
  <meta charset="UTF-8">
  <title>Islamabad United Squad PSL 10</title>
...
<!-- Navbar -->
<header class="bg-red-psl text-white p-4 shadow-md sticky top-0 z-50">
  <div class="max-w-6xl mx-auto flex justify-between items-center">
    <h1 class="text-2xl font-bold text-orange-psl">Islamabad United</h1>
...
<!-- Captain Card -->
<section class="py-10 bg-orange-psl text-white text-center">
  <h2 class="text-3xl font-bold mb-4 text-red-psl">Islamabad United Squad – PSL 10</h2>
  <p class="mb-8">United we win – The pride of the capital city!</p>

  <?php if ($captain): ?>
    <div class="max-w-xl mx-auto bg-red-psl text-white p-6 rounded-lg shadow-lg flex flex-col items-center">
      <img src="images/<?= $captain['image'] ?>" alt="<?= $captain['name'] ?>" class="w-32 h-32 rounded-full mb-4 object-cover border-4 border-orange-psl">
